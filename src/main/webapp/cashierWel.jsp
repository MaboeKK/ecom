...
<html>
    ...
    <style>       
        ...
        .Sale2
        {
            ...
            height: 120px;
            margin-left: 30%;
            background-image: url(Images/Reciver/scanning.png);margin-top: 20px;
            border-radius: 40%;
                        background-size: cover;
            background-repeat: no-repeat;
            background-color: #fff;
            ...
            <div class="optionContainer">
                ...
                <section class="index-cat">
                    ...
                    <div class="index-cat-box">
                        ...
                        <a href="cashierSale.jsp"><h2>Make A Sale(s)</h2></a>
                    ...
                    <div class="index-cat-box">
                        ...
                        <a href="lookupItem.jsp"><h2>Lookup Item(s)</h2></a>
                    </div>
                    <div class="index-cat-box">
                        <div class="Znumber">
                ...
                <section class="index-cat">
                    ...
                    <div class="index-cat-box"> 
                        ...
                        <a href="CustomCode.jsp"><h2>Create Custom Barcode</h2></a>
                    </div>
                    <div class="index-cat-box">
                        <div class="Lookup2">
